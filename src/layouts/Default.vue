    ...
    <header class="border-t-14 border-purple-700">
      <nav class="container mx-auto flex flex-wrap justify-between items-center py-8">
        ...
        <div class="block lg:hidden">
          <button @click="toggle" class="flex items-center px-3 py-2 border rounded border-gray-500 hover:text-gray-600 hover:border-gray-600" aria-label="icon">
    ...
    <footer class="bg-purple-700 text-white">
      <div class="container mx-auto flex flex-col lg:flex-row items-center justify-between py-8">
        ...
        <ul class="flex items-center">
          <li class="mr-8">
            <a href="mailto:criston2011@gmail.com" class="text-white hover:text-gray-400">
          ...
          <li class="mr-8">
            <a href="https://github.com/cristonkrizz" target="_blank" class="text-white hover:text-gray-400">
          ...
          <li class="mr-8">
            <a href="https://twitter.com/crstnmac" target="_blank" class="text-white hover:text-gray-400">
          ...
          <li>
            <a href="https://instagram.com/crstnmac" target="_blank" class="text-white hover:text-gray-400">
