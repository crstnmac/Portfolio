    ...
    <div class="overflow-x-hidden border-gray-200 border-b">
      <div class="get-to-know-me container-inner mx-auto text-xl pb-16 relative">
        <a
          ...
          target="_blank"
        >
          <div class="cursor-pointer absolute right-0 py-4 lg:px-4">
            <div
              class="p-2 bg-purple-800 items-center text-indigo-100 leading-none lg:rounded-full flex lg:inline-flex"
              role="alert"
            >
              <span
        ...
        <div class="flex flex-col sm:flex-row justify-between items-center mb-16">
          ...
          >Cris here..!!.I am a full stack web developer and a Open-Source enthuasist.I like EDM.</div>
        </div>
      </div>
      <!-- end get-to-know me -->
    </div>
